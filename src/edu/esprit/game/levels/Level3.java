...
public class Level3 {
	...
	String namesMajSplit = employees.stream().map(e->e.getName().toUpperCase()).reduce("", (n1, n2)-> n1+ "#" +n2);
	...
	Map<Integer, String> mm = employees.stream().collect(Collectors.toMap(e->e.getSalary(), e->e.getName(), (n1, n2)->n1+","+n2));
